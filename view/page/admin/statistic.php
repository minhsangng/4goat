            ...
            <table class="table align-items-center my-4 text-center">
                ...
                <tbody>
                    ...
                    <tr class="odd:bg-white even:bg-gray-200">
                        <td colspan="6"><p class="text-bold text-left pl-6 m-0">Doanh thu</p></td>
                        <td><?php echo '<p class="m-0">'.number_format($revenue, 0, ",", ".").' <sup>đ</sup></su></p>'; ?></td>
                    </tr>
                </tbody>
            </table>
